  ...
  try {
    ...
    const [productsResult, categoriesResult, flashSalesResult] = await Promise.all([
      supabase
        ...
        .select('id, slug, name, description, price, icon_url, category_id, is_available, is_approved, tags, stock, sold_count, chat_allowed, seller_id, view_count, images, product_type, type_metadata')
