  ...
  return (
    <div className="flex min-h-dvh flex-col lg:flex-row">
      ...
      <div className="flex min-h-dvh w-full flex-col items-center bg-black text-white lg:w-1/3 lg:justify-center lg:p-8">
        {/* Mobile Background */}
        <div className="relative w-full overflow-hidden lg:hidden" style={{ minHeight: "200px" }}>
          <img
            src={signinBackground}
            alt="Background"
            className="absolute inset-0 h-full w-full object-cover"
        ...
        <div className="flex w-full max-w-sm flex-col items-center px-6 py-8 lg:px-0">
          {/* Logo Icon with white background box */}
          ...
          <div className="w-full rounded-2xl border border-gray-800 bg-gray-900/50 p-6">
            {/* Google Button */}
            <button className="mb-5 flex w-full items-center justify-center gap-3 rounded-lg border border-gray-700 bg-transparent px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-gray-800">
            ...
            <div className="relative mb-5">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-gray-900/50 px-4 text-gray-500">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-gray-700 bg-black/50 px-4 py-3 text-sm text-white placeholder:text-gray-500 focus:border-gray-500 focus:outline-none focus:ring-0"
                />
              </div>
