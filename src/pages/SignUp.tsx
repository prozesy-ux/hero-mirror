...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left side - Background and Welcome */}
      <div className="hidden lg:flex lg:w-2/3 relative">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 max-w-2xl">
          ...
          <p className="text-xl text-gray-300">
            Get access to 10,000+ premium AI prompts and unlock your creative potential.
          </p>
        </div>
      </div>

      {/* Right side - Sign Up Form */}
      <div className="w-full lg:w-1/3 bg-gray-900 flex flex-col justify-center px-8 lg:px-12">
        <div className="max-w-md w-full mx-auto">
          <div className="flex items-center gap-3 mb-8">
            ...
            />
            <span className="text-2xl font-bold text-white">PromptHero</span>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white text-gray-900 font-semibold py-3 px-4 rounded-lg hover:bg-gray-100 transition-colors mb-6"
          >
