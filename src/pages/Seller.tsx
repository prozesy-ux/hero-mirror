...
import SellerReviewsManagement from '@/components/seller/SellerReviewsManagement';
...
const SellerMainContent = () => {
  ...
  return (
    <main className={`
      min-h-screen bg-[#FCFCFC] transition-all duration-300
      pt-0 pb-20 lg:pb-0
    ...
    `}>
      <div className="p-3 sm:p-4 lg:p-6">
        <Routes>
          ...
          <Route path="/products/edit/:productId" element={<NewProduct />} />
