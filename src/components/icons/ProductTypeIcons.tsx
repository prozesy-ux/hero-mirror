...
export const PRODUCT_TYPES = [
  ...
  },
  {
    ...
    description: 'Lessons with video, text, or a combination',
    Icon: CourseIcon,
  ...
  },
  {
    id: 'ebook',
    name: 'E-book',
    description: 'PDF, ePub, or other document formats',
    Icon: EbookIcon,
    color: 'bg-amber-50 border-amber-200',
  },
  {
  ...
  },
  {
    id: 'commission',
    name: 'Commission',
    description: 'Custom services with 50/50 split',
    Icon: CommissionIcon,
    color: 'bg-amber-50 border-amber-200',
  },
  {
    id: 'call',
    name: 'Call',
    description: 'Scheduled calls or consultations',
    Icon: CallIcon,
    color: 'bg-pink-50 border-pink-200',
  },
  {
    id: 'coffee',
    name: 'Coffee',
    description: 'Tips, donations, or support',
    Icon: CoffeeIcon,
    color: 'bg-teal-50 border-teal-200',
  },
] as const;
