...
const WalletManagement = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tabs */}
      <div className="flex gap-2 border-b border-[#151516] pb-2">
        <button
      ...
      <div className="relative">
        ...
        <Input
          ...
          className="pl-10 bg-[#030304] border-[#151516] rounded-sm text-white placeholder-zinc-600"
        />
      </div>
      ...
      {activeTab === 'wallets' && (
        <div className="bg-[#0a0a0b] border border-[#151516] rounded-none overflow-hidden">
          <Table>
            <TableHeader>
              <TableRow className="border-[#151516] bg-[#080809] hover:bg-[#080809]">
            ...
            <TableBody>
              {loading ? (
                ...
                filteredWallets.map((wallet) => (
                  <TableRow key={wallet.id} className="border-[#151516] hover:bg-[#0c0c0d] transition-all">
            ...
            <TableBody>
              {loading ? (
                ...
                filteredTransactions.map((tx) => (
                  <TableRow key={tx.id} className="border-[#151516] hover:bg-[#0c0c0d] transition-all">
