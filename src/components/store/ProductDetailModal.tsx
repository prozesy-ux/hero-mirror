...
const ProductDetailModal = ({
        ...
        <div className="flex items-center gap-2.5 p-2.5 bg-black/5 rounded-xl">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5">
              <span className="font-semibold text-black text-sm truncate">{seller.store_name}</span>
              {seller.is_verified && (
                <BadgeCheck className="w-3.5 h-3.5 text-black flex-shrink-0" />
              )}
            </div>
            <p className="text-[10px] text-black/50">{seller.total_orders || 0} orders</p>
          </div>
        </div>
  ...
  // Desktop Dialog Content (70/30 horizontal split)
      ...
      <div className="lg:w-[65%]">
        ...
        <div className="mt-4 space-y-3">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-medium text-black text-sm">{seller.store_name}</span>
            {seller.is_verified && (
      ...
      <div className="lg:w-[35%]">
        <div className="bg-white rounded-xl p-4 border border-black/20 sticky top-0">
          ...
          <button
            ...
            className="flex items-center gap-2 text-xs text-black/60 hover:text-black py-1.5 transition-colors mb-3"
          >
          ...
          <div className="flex items-center gap-2 pt-3 border-t border-black/20">
            ...
            <button onClick={() => handleShare('twitter')} className="p-1.5 text-black/40 hover:text-black">
              <Twitter className="w-3.5 h-3.5" />
            </button>
            <button onClick={() => handleShare('facebook')} className="p-1.5 text-black/40 hover:text-black">
              <Facebook className="w-3.5 h-3.5" />
            </button>
            <button onClick={() => handleShare('copy')} className="p-1.5 text-black/40 hover:text-black">
