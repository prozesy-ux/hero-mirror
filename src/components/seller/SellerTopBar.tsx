...
const SellerTopBar = () => {
  ...
  return (
    <header 
      className={`fixed top-0 right-0 h-16 bg-[#f1f5f9] border-b border-black/10 z-40 transition-all duration-300 hidden lg:flex items-center justify-between px-6 dashboard-inter ${
