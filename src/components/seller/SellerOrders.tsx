  ...
  if (loading) {
    return (
      <div className="space-y-6">
        <Skeleton className="h-8 w-48 mb-6 rounded border" />
        <div className="space-y-4">
          {[1, 2, 3].map(i => <Skeleton key={i} className="h-24 rounded border" />)}
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6 seller-dashboard">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
        ...
        <div className="bg-white border rounded p-8">
          ...
          <div className="text-4xl font-semibold text-blue-600">{deliveredCount}</div>
        </div>
        <div className="bg-white border rounded p-8">
          <div className="text-base text-slate-700 mb-2">Completed</div>
          <div className="text-4xl font-semibold text-emerald-600">{completedCount}</div>
        </div>
        <div className="bg-white border rounded p-8">
          <div className="text-base text-slate-700 mb-2">Refunded</div>
          <div className="text-4xl font-semibold text-red-600">{refundedCount}</div>
        </div>
      </div>
