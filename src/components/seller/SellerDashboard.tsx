...
const SellerDashboard = () => {
  ...
  return (
    <div className="space-y-5" style={{ backgroundColor: '#f1f5f9', minHeight: '100vh', padding: '32px', fontFamily: '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>
