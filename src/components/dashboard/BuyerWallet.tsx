        ...
        <DialogContent className="max-w-sm p-0 overflow-hidden">
          ...
          <DialogFooter className="flex-col gap-2 p-6 pt-0">
            <Button
              ...
              className="w-full bg-[#FF90E8] text-black border border-black hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded"
            >
              {otpVerifying ? (
                <>
            ...
            {addAccountStep === 'bank' && (
              <div className="animate-fade-up">
                ...
                <div className="grid grid-cols-2 gap-3 max-h-64 overflow-y-auto">
                  {getAvailableBanks().map((bank) => (
                    <button
                      ...
                      className="p-3 rounded border-2 border-slate-200 hover:border-black hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all text-left group"
                    >
                      <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="w-full mt-3 p-4 rounded border-2 border-dashed border-black hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:bg-[#FFF5FB] transition-all text-center"
                >
                ...
                <div className="grid grid-cols-2 gap-3">
                  {getAvailableDigitalWallets().map((wallet) => (
                    <button
                      ...
                      className="p-4 rounded border-2 border-slate-200 hover:border-black hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all text-center group"
