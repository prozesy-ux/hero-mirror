...
const DashboardTopBar = ({
  ...
  return (
    <header className={`hidden lg:flex fixed top-0 right-0 z-50 h-16 bg-[#F3EAE0] border-b border-black/10 transition-all duration-300 ${sidebarCollapsed ? 'left-[72px]' : 'left-52'}`} style={{ fontFamily: '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>
