...
const DashboardTopBar = ({
  ...
  return (
    <header className={`hidden lg:flex fixed top-0 right-0 z-50 h-16 bg-[#FCFCFC] border-b border-black/10 transition-all duration-300 ${sidebarCollapsed ? 'left-[72px]' : 'left-52'}`}>
